...
/**
 * @brief Inicializa el dispositivo DS1307 y arranca el reloj.
 *
...
/**
 * @brief Establece el bit de detención del reloj (CH) en el DS1307.
 *
 * Esta función configura el bit de detención del reloj (CH) en el registro de segundos
...
/**
 * @brief Obtiene el estado del bit de detención del reloj (CH) en el DS1307.
 *
 * Esta función lee el bit de detención del reloj (CH) del registro de segundos del DS1307.
 *
 * @return El estado del bit CH. Si es 1, el reloj está detenido. Si es 0, el reloj está corriendo.
 */
...
void DS1307_SetRegByte(uint8_t regAddr, uint8_t val) {
    ...
    _i2c->Transmit(DS1307_I2C_ADDR, bytes, 2, DS1307_TIMEOUT);
}
